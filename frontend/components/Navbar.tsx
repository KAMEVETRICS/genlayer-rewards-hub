...
import { useContests } from "@/lib/hooks/useContentRewards";
...
export function Navbar() {
  ...
  const activeContests = contests?.filter(c => c.is_active && c.spots_remaining > 0).length || 0;
            ...
            >
              ...
              <div className="hidden lg:flex items-center gap-6 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-foreground font-bold text-accent">{activeContests}</span>
                </div>
              </div>
